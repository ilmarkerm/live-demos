...
cat /scripts/listener.ora
read -p "Press Enter to continue..."

echo "Replacing listener.ora to enable TCPS endpoint"
cp /scripts/listener.ora /opt/oracle/product/26ai/dbhomeFree/network/admin/listener.ora
...
cat /scripts/sqlnet.ora
read -p "Press Enter to continue..."

cp /scripts/sqlnet.ora /opt/oracle/product/26ai/dbhomeFree/network/admin/sqlnet.ora
